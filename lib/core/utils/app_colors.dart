...
class AppColors {
  ...
  static const Color primary = Color(0xFF02369C); // BASE
  ...
  // Black/Gray Palette
  static const Color black5 = Color(0xFFEDEFF3);
  ...
  static const Color lightGreen = Color(0xFFD0F9D1);
  static const Color lightRed = Color(0xFFF9D3D3);
