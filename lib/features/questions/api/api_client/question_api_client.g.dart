...
class _QuestionApiClient implements QuestionApiClient {
  ...
  Future<QuestionResponseModel> getQuestions({
    ...
    final _options = _setStreamType<QuestionResponseModel>(
  ...
  Future<CheckQuestionsResponseModel> checkQuestions({
    ...
    final _options = _setStreamType<CheckQuestionsResponseModel>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CheckQuestionsResponseModel _value;
    try {
      _value = CheckQuestionsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
